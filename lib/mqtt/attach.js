      ...
      startPoller({
        ...
        run: async () => {
          ...
          bridge.publishSmartAcSensors(slug, {
            ...
            night_mode: sleep ? sleep.night_mode : undefined,          // 열대야쾌면(빈 값은 null)
            night_elapsed: sleep ? sleep.elapsed : undefined,          // ⚠️단위 미검증 — 원값
          });
        },
      });
    }
    ...
    startPoller({
      ...
      run: async () => {
        ...
        bridge.publishLaundryState(slug, {
          ...
          alarm_ok: alarm ? alarm.ok : undefined,
          course: course ? (course.code || null) : undefined,     // 빈 값은 null 로 살린다(M-1)
        });
      },
    });
  } else {
