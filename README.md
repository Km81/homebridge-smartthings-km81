...
**스윙 토글로 무엇을 켤지** — `스윙(Swing) 토글 ↔ 기능`에서 고릅니다.

| 고를 수 있는 값 | 동작 |
|---|---|
| **무풍** | 무풍을 켜고 끕니다 |
| **회전** | 기기가 지원한다고 알려준 방향으로 회전합니다 — **어느 방향인지 몰라도 됩니다** |
| 상하 바람 / 좌우 바람 / 상하좌우 | 그 방향으로 고정해 씁니다 |
| 사용 안 함 | 토글을 만들지 않습니다 |

> 끄면 항상 **고정**을 보냅니다.
> 기기마다 지원하는 방향이 다릅니다(같은 삼성이라도 창문형은 좌우만, 천장형은 네 방향 전부).
> **잘 모르시면 회전**을 고르세요 — 플러그인이 기기에 물어 맞는 값을 씁니다.
> 지원하지 않는 방향을 고르면 로그가 지원 목록과 함께 알려 줍니다.
>
